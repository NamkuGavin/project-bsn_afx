import 'package:bsn_afx/page/home_page.dart';
      ...
      body: Stack(
        children: [
          Image.asset("assets/background.png",
              scale: 10, fit: BoxFit.cover, width: double.infinity),
          Container(
                ...
                children: [
                  ...
                  ElevatedButton(
                    style: ButtonStyle(
                      ...
                      backgroundColor:
                          MaterialStateProperty.all(SharedColor.primary),
                      overlayColor: MaterialStateProperty.resolveWith<Color?>(
                        (Set<MaterialState> states) {
                          if (states.contains(MaterialState.hovered)) {
                            return SharedColor.hoverButtonLogin;
                          }
                          return null;
                        },
                      ),
